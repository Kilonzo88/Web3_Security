...
This vulnerability is part of a broader class of token behaviors known as "Weird ERC20s." For a complete list of tokens that break standard assumptions (including fee-on-transfer, rebasing, and approval race conditions), refer to the industry-standard repository:
